...
public class FarSpeakerCommand extends SequentialCommandGroup {
  ArmSubsystem m_armSubsystem;
  IntakeSubsystem m_intakeSubsystem;
  OutakeSubsystem m_outakeSubsystem;
  /** Creates a new SpeakerCommand. */
  public FarSpeakerCommand(ArmSubsystem armSubsystem, IntakeSubsystem intakeSubsystem, OutakeSubsystem outakeSubsystem) {
