...
public class SpeakerDriverCommand extends SequentialCommandGroup {
  ArmSubsystem m_armSubsystem;
  IntakeSubsystem m_intakeSubsystem;
  OutakeSubsystem m_outakeSubsystem;
  /** Creates a new SpeakerCommand. */
  public SpeakerDriverCommand(ArmSubsystem armSubsystem, IntakeSubsystem intakeSubsystem, OutakeSubsystem outakeSubsystem) {
    m_armSubsystem = armSubsystem;
    m_intakeSubsystem = intakeSubsystem;
    m_outakeSubsystem = outakeSubsystem;
    // Add your commands in the addCommands() call, e.g.
    // addCommands(new FooCommand(), new BarCommand());
    addCommands(new ParallelCommandGroup( new MoveArmToPoseCommand(m_armSubsystem, Constants.ARM_SHOOTER_ANGLE-4),
