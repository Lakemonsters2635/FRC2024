...
public class OuttakeInCommand extends Command {
  /** Creates a new OuttakeInCommand. */
  OutakeSubsystem m_outakeSubsystem;
  public OuttakeInCommand(OutakeSubsystem outakeSubsystem) {
  ...
  public void initialize() {
    m_outakeSubsystem.setInOutakePower();
  }
