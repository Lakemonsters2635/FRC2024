...
public final class Constants {
   ...
   public static final int APRIL_TAG_BUTTON = 1;
   ...
   public static final int NOTE_TAKER_BUTTON = 1;

   public static final double CAMERA_HEIGHT_FROM_GROUND = 0.887857;// In meters
}