...
public final class Constants {
    ...
    public static final double FRONT_LEFT_ANGLE_OFFSET_COMPETITION = Math.toRadians(49); //3.0346
    ...
    public static final double FRONT_RIGHT_ANGLE_OFFSET_COMPETITION = Math.toRadians(8.5-28.3); //2.9835
    ...
    public static final double BACK_LEFT_ANGLE_OFFSET_COMPETITION = Math.toRadians(-11.3-9.3); // 3.0775
    ...
    public static final double BACK_RIGHT_ANGLE_OFFSET_COMPETITION = Math.toRadians(-0.7+86.5); //3.01
